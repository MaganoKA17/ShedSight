...
const TABS = ["Overview", "Trends", "Stress Hours", "Data Table", "AI Insights", "Predictions"]
  ...
  return (
    <div style={{
      ...
      {activeTab === "Predictions" && (
          <div style={{ background: theme.card, borderRadius: "12px", padding: "24px", border: `1px solid ${theme.border}` }}>
            <h2 style={{ marginTop: 0, color: theme.text }}>Grid Stress Predictions</h2>
            <p style={{ color: theme.subtext, marginBottom: "24px" }}>
              Next 24 hours of grid stress predictions generated by a Random Forest ML model
              trained on historical Eskom hourly data.
            </p>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              <thead>
              <tr style={{ borderBottom: `1px solid ${theme.border}` }}>
                <th style={{ textAlign: "left", padding: "8px", color: theme.subtext }}>Hour</th>
                <th style={{ textAlign: "left", padding: "8px", color: theme.subtext }}>Risk Level</th>
                <th style={{ textAlign: "left", padding: "8px", color: theme.subtext }}>Probability</th>
              </tr>
              </thead>
              <tbody>
              {allPredictions.length > 0 ? (
                  allPredictions.map((p, index) => (
                      <tr key={index} style={{ borderBottom: `1px solid ${theme.border}` }}>
                        <td style={{ padding: "8px", color: theme.text }}>
                          {new Date(p.predicted_hour).toLocaleTimeString("en-ZA", { hour: "2-digit", minute: "2-digit" })}
                        </td>
                        <td style={{ padding: "8px" }}>
                <span style={{
                  background: p.risk_level === "High" ? "#ff4444" : p.risk_level === "Medium" ? "#ff6b00" : "#22c55e",
                  ...
                  {p.risk_level}
                        ...
                        <td style={{ padding: "8px", color: theme.accent }}>
                  ...
                  <tr>
                    <td colSpan="3" style={{ padding: "16px", color: theme.subtext, textAlign: "center" }}>
                      No high or medium risk predictions for the next 24 hours
                    </td>
                  </tr>
              )}
              </tbody>
